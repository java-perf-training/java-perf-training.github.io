...
sections:
      ...
      items:
        ...
        - title: "Многопоточность JVM: проблемы и их диагностика"
          text: |
            Ведущий: **Алексей Рагозин**<br/>
            <br/>
            **<ins>[Скачать](uploads/multithreading.pdf)</ins>** описание модуля.<br/>
            Основные разделы:
          feature_icon: bolt
          features:
  ...
  - block: cta-card
    content:
      ...
      text: Освой инструменты сегодня, чтобы завтра уверенно применять их, не&nbsp;тратя время на изучение.
      button:
        text: Записаться
        url: https://aragozin.timepad.ru/events/
    design:
