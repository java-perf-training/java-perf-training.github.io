...
sections:
  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        В Java десятки инструментов для анализа и оптимизации производительности. Но есть проблема – у них высокий порог входа. А когда production лежит, читать документацию некогда.
